...
class ToastUtils private constructor() {
    ...
    private class ApplicationContextWrapperForApi25 internal constructor() : ContextWrapper(App.instance) {
    ...
    companion object {
         ...
         *
         * @param msgColor The color of msg.
         */
        ...
        /**
         * Set the text size of msg.
         *
         * @param textSize The text size of msg.
         */
        ...
        private fun show(@StringRes resId: Int, duration: Int) {
            show(App.instance.resources.getText(resId).toString(), duration)
        }

        private fun show(@StringRes resId: Int, duration: Int, vararg args: Any) {
            show(String.format(App.instance.resources.getString(resId), args), duration)
        }
        ...
        private fun showToast() {
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
                try {
                    ...
                    field.set(sToast!!.view, ApplicationContextWrapperForApi25())
                } catch (throwable: Throwable) {
        ...
        private fun getView(@LayoutRes layoutId: Int): View? {
            val inflate = App.instance.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
