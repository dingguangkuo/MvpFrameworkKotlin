...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = App.Companion.getInstance()
                    .getPackageManager()
                    .getPackageInfo(App.Companion.getInstance().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && App.Companion.getInstance().getExternalCacheDir() != null)
                mDefaultDir = App.Companion.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = App.Companion.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
