...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        App.Companion.getInstance().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) App.Companion.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) App.Companion.getInstance().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) App.Companion.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
